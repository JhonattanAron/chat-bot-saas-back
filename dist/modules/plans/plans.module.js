    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: stick_references_schema_1.StickReferences.name, schema: stick_references_schema_1.StickReferencesSchema },
            ]),
        ],
        controllers: [plans_controller_1.PlansController],
        providers: [plans_service_1.PlansService],
        exports: [plans_service_1.PlansService, mongoose_1.MongooseModule],
    })
], PlansModule);
