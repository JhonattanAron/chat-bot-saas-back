...
let DashboardController = class DashboardController {
    ...
    async getUserBots(userId) {
        try {
            ...
            throw new common_1.HttpException("Error al obtener bots del usuario", common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async getTokenUsage(userId) {
        try {
            ...
            throw new common_1.HttpException("Error al obtener uso de tokens", common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async getAnalytics(userId) {
        try {
            ...
            throw new common_1.HttpException("Error al obtener análisis", common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
...
__decorate([
    (0, common_1.Get)("bots/:userId"),
    __param(0, (0, common_1.Param)("userId")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "getUserBots", null);
__decorate([
    (0, common_1.Get)("token-usage/:userId"),
    __param(0, (0, common_1.Param)("userId")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "getTokenUsage", null);
__decorate([
